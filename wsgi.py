...
# web application at http://mmkkshim.pythonanywhere.com/
...
#import sys
#
#path = '/home/mmkkshim/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/mmkkshim/mysite/mysite/settings.py'
## and your manage.py is is at '/home/mmkkshim/mysite/manage.py'
#path = '/home/mmkkshim/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/mmkkshim" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/mmkkshim/myproject"
#path = '/home/mmkkshim/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
